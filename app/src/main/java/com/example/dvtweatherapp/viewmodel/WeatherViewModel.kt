...
class WeatherViewModel(private val weatherRepository: WeatherRepository) : ViewModel() {
    ...
    fun getForecast(place: String?): MutableLiveData<WeatherResults<Weather>> {
    ...
    fun getCurrentWeather(place: String?): MutableLiveData<WeatherResults<CurrentWeatherModel>> {
        val weatherData: MutableLiveData<WeatherResults<CurrentWeatherModel>> = MutableLiveData()
        viewModelScope.launch {
